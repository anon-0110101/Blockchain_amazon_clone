      ...
      <div className='product__details'>
        ...
        <div className='product__overview'>
          ...
          <p>
            ...
            commodi error modi eaque! Iure repudiandae temporius ex? Optio!
          </p>
          </div>
          <div className='product__order'>
            ...
            <p>
              FREE delivery <hr />
              <strong>
                {new Date(Date.now() + 3456000000).toLocaleDateString(undefined, { weekday: 'long', month: 'long', day: 'numeric' })}
              </strong>
            </p>
